...
if ! [ -d "$venv" ]; then
  ...
  sudo apt-get install --upgrade -y python3 python3-venv python3-dev portaudio19-dev wget curl pulseaudio apt-transport-https ca-certificates gnupg ffmpeg build-essential cmake
